...
var (
	styleWarning = lipgloss.NewStyle().Bold(true)
	styleError   = lipgloss.NewStyle().Bold(true)
	styleInfo    = lipgloss.NewStyle().Faint(true)
	styleName    = lipgloss.NewStyle().Bold(true)
	styleDim     = lipgloss.NewStyle().Faint(true)
	styleCurrent = lipgloss.NewStyle().Bold(true).Underline(true)
	styleTarget  = lipgloss.NewStyle().Bold(true).Reverse(true)
	styleSaved   = lipgloss.NewStyle().Underline(true)
	styleLive    = lipgloss.NewStyle().Faint(true)
	styleDelete  = lipgloss.NewStyle().Bold(true).Reverse(true)
	styleCursor  = lipgloss.NewStyle().Bold(true)
	styleKey     = lipgloss.NewStyle().Bold(true).Reverse(true).Padding(0, 1)
	styleKeyBlue = lipgloss.NewStyle().Bold(true).Underline(true).Padding(0, 1)
	styleKeyRed  = lipgloss.NewStyle().Bold(true).Reverse(true).Padding(0, 1)
	styleBarOn   = lipgloss.NewStyle().Bold(true)
	styleBarOff  = lipgloss.NewStyle().Faint(true)
	styleBarWarn = lipgloss.NewStyle().Faint(true)
)
